...
def collapseTraceTO(args):
    if any(arg['type'] == 'c10::optional<ScalarType>' for arg in args) and any(arg['type'] == 'c10::optional<Layout>' for arg in args) and any(arg['type'] == 'c10::optional<Device>' for arg in args) and any(arg['type'] == 'c10::optional<bool>' for arg in args):
        index = 0
...
def create_python_bindings(python_functions, has_self, is_module=False):
    ...
    def emit_single_dispatch(declaration, out_idx, base_env):
        ...
        has_tensor_options = inputs_have_to(inputs)
        ...
        def parse_arg(arg, arg_index, unpack_args=False):
            ...
            if unpack_args and typename != 'c10::optional<ScalarType>': 
